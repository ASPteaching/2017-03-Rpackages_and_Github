...
- Si queremos descargarnos un repositorio podemos hacerlo
    + Vamos a GitHub y nos situamos en el repositorio que deseamos clonar
    + Seleccionamos la opción `Clone/download', Esto copiará la dirección del repositorio en la memoria.
- Podemos clonarlo desde la consola o desde Rstudio.
...
# Caso 4.2. Clonar repositorio en Rstudio

- La forma más sencilla de clonar un repositorio es creando un  proyecto bajo control de versión desde Rstudio;
