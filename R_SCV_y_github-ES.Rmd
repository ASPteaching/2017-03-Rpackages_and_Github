...
# Caso 4: Clonar un repositorio de github

- Si queremos descargarnos un repositorio podemos hacerlo
    + Vamos a GitHub y nos situamos en el repositorio
    + Seleccionamos la opción `Clone/download', Esto copiará la dirección del repositorio en la memoria.
- Para clonarlo desde la consola:
    + En nuestro ordenador nos situamos en el directorio donde se desa situar el repositorio clonado
    + Tecleamos: `git clone nomRepositori`
- Podemos hacerlo también desde Rstudio
    + Seleccionar __File / New Project... / Version Control / Git__
    + Donde se indica "Repository URL" pegar la URL del repositorio
