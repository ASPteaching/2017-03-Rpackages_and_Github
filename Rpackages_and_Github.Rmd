...
1'. [Abans del punt 4] Creació i dipòsit de les dades d'exemple*
2'. [Després del punt 4] Dipòsit ("upload") del paquet a github per fer-lo accessible als potencials usuaris
3'. [Després del punt 4] Instal·lació del paquet des-de els arxius locals o des de `github`.
